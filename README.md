...
![Versión](https://img.shields.io/badge/Versi%C3%B3n-1.19.3-blue?style=for-the-badge&logo=git&logoColor=white)
...
- **Última versión (v1.19.3):** Corrección y blindaje de formateo Black en `runs.py`, garantizando 100% de éxito en el pipeline de CI (backend linters, pytest, SAST y frontend build), desarrollada con **Gemini 3.8 Flash (High)** (vía Google Antigravity).
