...
class QualityService:
    ...
    def analyze_dataframe(
        ...
        for col_prof in profiling.columns:
            ...
            is_identifier = (
                col_prof.semantic_hint == SemanticHintEnum.ID
                or col_prof.column_name.lower().startswith("id")
                or col_prof.column_name.lower().endswith("_id")
                or col_prof.column_name.lower().startswith("cod")
                or col_prof.column_name.lower().endswith("_cod")
                or "codigo" in col_prof.column_name.lower()
                or "code" in col_prof.column_name.lower()
                or "cif" in col_prof.column_name.lower()
                or "dni" in col_prof.column_name.lower()
                or "nif" in col_prof.column_name.lower()
                or "sku" in col_prof.column_name.lower()
        ...
        for col_prof in profiling.columns:
            ...
            is_quant_column = (
                ...
                or any(
                    k in col_prof.column_name.lower()
                    for k in [
                        "precio",
                        "salario",
                        "sueldo",
        ...
        integrity_score = (
            round(max(0.0, 100.0 * (1.0 - (integrity_violations / row_count))), 2) if row_count > 0 else 100.0
        )
