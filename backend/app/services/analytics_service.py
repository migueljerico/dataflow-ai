...
class AnalyticsService:
    ...
    def generate_report(run_id: str) -> ExecutiveAnalyticsReport:
        ...
        if any("aht" in c for c in cols_lower) or any("campana" in c for c in cols_lower) or any("llamadas" in c for c in cols_lower):
            ...
            if camp_col:
                ...
                for cat, count in counts.items():
                    ...
                    breakdown.append(CategoryDistribution(
        ...
        elif any("precio" in c for c in cols_lower) or any("producto" in c for c in cols_lower) or any("comercial" in c for c in cols_lower):
            domain = "sales"
        ...
        elif any("empleado" in c for c in cols_lower) or any("salario" in c for c in cols_lower) or any("departamento" in c for c in cols_lower):
