...
class ExecutionSummaryItem(BaseModel):
    ...
    score_before: Optional[float] = Field(None, description="Quality score original")
    score_after: Optional[float] = Field(None, description="Quality score limpio")
    score_delta: Optional[float] = Field(None, description="Variación del quality score")
    comparison_available: bool = Field(True, description="Indica si la comparación de calidad está disponible")
